...
This project, developed within the scope of a Cyber Security internship and it is a group project, serves as a proof-of-concept (PoC) for endpoint surveillance malware. While popularly known as a "keylogger," the technical classification is **Keystroke Logging Spyware**.
